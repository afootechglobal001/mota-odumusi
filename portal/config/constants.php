<?php
	...
	$appName='schoolBolt'; 
	$clientName='Mota Odumusi Anglican Nursery/Primary School';
	/////////////////////////////////////////////////////////////////////////////////
	$clientWebsiteUrl='https://motaodumusianglicanschools.com';
	$clientWebsiteContactUsUrl=$clientWebsiteUrl.'/contact-us';
	$websiteUrl='https://motaodumusianglicanschools.com/portal'; /// For Live Server Url //
...
var clientId = "1f2da662c378a56139cc86341c19cdae"; /// for dev
var clientAddress = "<?php echo $websiteAutoUrl;?>";
var apiKey = 'a7c37b6289b9dd879b2c005118d3ef14'; /// For API Key //
var endPoint = 'https://schoolbolt.org/api/production'; /// Server End Point url
