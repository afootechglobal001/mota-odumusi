        ...
        <div class="inner-div">
            ...
            <nav>
                    ...
                    <li id="expand-li"
                        ...
                        <ul class="animated fadeIn">
                            <a href="<?php echo $website_url?>/about" title="About <?php echo $thename?>">
                                <li class="about">About <?php echo $thename?></li>
                            </a>
                ...
                <a href="<?php echo $website_url?>/portal/" title="Apply For Admission">
                    <button class="btn" title="Apply For Admission"><img src="<?php echo $website_url?>/all-images/images/pencil.png" alt="Portal"> PORTAL</button></a>
